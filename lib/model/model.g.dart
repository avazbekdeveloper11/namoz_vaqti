...
class ModeTimesAdapter extends TypeAdapter<ModeTimes> {
  @override
  final int typeId = 0;

  @override
  ModeTimes read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ModeTimes obj) {
    writer
      ..writeByte(3)
      ..writeByte(0)
      ..write(obj.timings)
